...
- **Sensirion SPS30 Laser PM Sensor**: Measures precise particle mass concentrations ($\mu\text{g/m}^3$) and particle count concentrations ($\#/cm^3$) via UART (`Serial2`).
...
| `analog-input-5` | `KEY_PM0_5_NUM`  | $\#/\text{cm}^3$  | $\text{NC}_{0.5}$ Number Concentration |
| `analog-input-6` | `KEY_PM1_0_NUM`  | $\#/\text{cm}^3$  | $\text{NC}_{1.0}$ Number Concentration |
| `analog-input-7` | `KEY_PM2_5_NUM`  | $\#/\text{cm}^3$  | $\text{NC}_{2.5}$ Number Concentration |
| `analog-input-8` | `KEY_PM4_0_NUM`  | $\#/\text{cm}^3$  | $\text{NC}_{4.0}$ Number Concentration |
| `analog-input-9` | `KEY_PM10_NUM`   | $\#/\text{cm}^3$  | $\text{NC}_{10}$ Number Concentration |
